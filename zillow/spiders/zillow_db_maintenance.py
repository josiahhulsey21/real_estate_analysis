...
class ZillowDbMaintenanceSpider(scrapy.Spider):
    name = 'zillow_db_maintenance'
    ...
    def parse(self, response):
        ...
        #this is an edited version of the next button that will shutoff the crawler after so many pages. It is set to only scrape the first page atm.        
        if next_page != f'{next_page[:-4]}3_p/':          
            yield scrapy.Request(url=next_page, callback=self.parse)
        else:
            print('REACHED PAGE LIMIT.SHUTTING DOWN SPIDER!!!!!!!!!!!!!!')
...
# https://www.zillow.com/homes/47714/sold/price=%100000
# https://www.zillow.com/homes/47714/sold/price=%200000/




# https://www.zillow.com/Smythe,-Evansville,-IN/sold/